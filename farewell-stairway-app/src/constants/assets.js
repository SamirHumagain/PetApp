// Central Asset Registry for Farewell to Stairway ("All Pets Go to Heaven")
export const ASSETS = {
  ...
  dogAscendingClouds: require('../../assets/dog_clouds_transparent.png'),
  dogAscendingSpace: require('../../assets/dog_space_transparent.png'),

  // Soul Assets - Cat (Transparent Ethereal PNGs)
  catSitting: require('../../assets/cat_sitting_transparent.png'),
  catAscendingClouds: require('../../assets/cat_clouds_transparent.png'),
